...
class Product(models.Model):
    ...
    category = models.ForeignKey(on_delete=models.SET_NULL, verbose_name='Категория', help_text='Пожалуйста, укажите категорию продукта', null=True, blank=True)
...
class Category(models.Model):
    name = models.CharField(max_lenght=100, verbose_name='Наименование категории', help_text='Введите наименование категории')
    description = models.CharField(max_lenght=100, verbose_name='Описание категории', help_text='Введите описание категории')
